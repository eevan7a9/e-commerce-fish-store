<template>
  <div>
    <div>
      <b-card-group deck>
        <b-card bg-variant="primary" text-variant="white" header="Products" class="text-center">
          <span>
            <svg
        ...
        <b-card bg-variant="secondary" text-variant="white" header="Users" class="text-center">
          <span>
            <svg
              xmlns="http://www.w3.org/2000/svg"
              width="24"
