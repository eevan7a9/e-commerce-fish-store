    ...
    <div class="bg-custom-violet nav-wrapper">
        <b-navbar toggleable="lg" type="dark" variant="bg-custom-violet" class="container text-uppercase w-100">
            ...
            <b-collapse id="nav-collapse" is-nav>
                <b-navbar-nav>
                    <b-nav-item to="/" class="text-light font-weight-bolder" :active="$route.name == 'home'">
                        Home
                    </b-nav-item>
                    ...
                    <b-nav-item to="/contact" class="text-light font-weight-bolder" :active="$route.name == 'contact'">
                        Contact
                    </b-nav-item>
                </b-navbar-nav>
            ...
            <b-dropdown-item href="#">FA</b-dropdown-item>
                    ...
                    <b-nav-item to="/register" class="text-light font-weight-bolder" :active="$route.name == 'register'" v-if="!token">
                        Register
                    </b-nav-item>
                    ...
                    <b-nav-item-dropdown right v-if="token">
                        ...
                        <b-dropdown-item :to="{name:'profile'}" v-if="token && user.role === 'buyer'">
                            Profile
                        </b-dropdown-item>
