    ...
    <div class="row featurette">
      ...
      <div class="col-md-5 order-md-1">
        <img
          ...
          data-src="holder.js/500x500/auto"
          alt="Generic placeholder image"
          src="https://cdn.pixabay.com/photo/2019/08/16/10/27/koi-fish-4410009_960_720.jpg"
        />
      </div>
    </div>
    ...
    <div class="row featurette">
      ...
      <div class="col-md-5">
        <img
          class="featurette-image img-fluid mx-auto"
          data-src="holder.js/500x500/auto"
          src="https://cdn.pixabay.com/photo/2019/04/02/19/29/madeira-4098596_960_720.jpg"
          alt="Generic placeholder image"
        />
      </div>
    </div>
