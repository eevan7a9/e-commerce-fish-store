  ...
  <section gsap="payment-support-container"
    ...
    <div class="tw-relative tw-max-w-screen-xl tw-m-auto tw-px-3 md:tw-px-28 tw-bg-white tw-border-t">
      <div
        ...
        <div gsap="payment-support-title" class="tw-max-w-[600px] tw-font-black tw-text-center tw-relative">
          <span class="tw-relative heading-gradient-primary tw-z-10">
            Payment Methods We Support
          </span>
          <q-img src="~assets/image-svg/empty_cart.svg"
            class="tw-absolute tw-bottom-0 tw-right-0 tw-translate-y-[50px] -tw-translate-x-[100px] sm:tw-translate-x-[24px] tw-z-0"
            width="180px" />
        </div>
      </div>

      <article gsap="payment-cod-container"
        class="tw-flex tw-flex-col sm:tw-flex-row tw-items-center tw-gap-3 tw-relative">
        <q-img src="~assets/image-svg/empty-box.svg"
          class="-tw-top-[100px] md:tw-max-w-[200px] tw-right-0 tw-mb-20 tw-absolute" width="280px"
          v-if="$q.screen.gt.sm" gsap="empty-box-payment" />
        ...
        <q-img src="~assets/image-svg/cod.svg" class="tw-max-w-[300px] sm:tw-max-w-[400px] md:tw-max-w-[400px]"
        ...
        <div class="tw-z-10 tw-relative tw-overflow-x-hidden">
          ...
          <p gsap="cod-description"
            class="lg:tw-text-[18px] tw-mt-4 tw-max-w-[800px] tw-pb-[100px] tw-leading-relaxed tw-font-light">
      ...
      <article class="tw-flex tw-flex-col-reverse sm:tw-flex-row tw-items-center tw-gap-3">
        <div>
          <h1
          ...
          <p gsap="stripe-description"
            class="sm:tw-text-right lg:tw-text-[18px] tw-mt-4 tw-max-w-[800px] tw-leading-relaxed tw-font-light">
          ...
          <div gsap="stripe-cards" class="tw-p-0 tw-flex tw-gap-1 tw-mt-8 sm:tw-justify-end">
        ...
        <div gsap="payment-card-container" class="sm:tw-h-[400px] tw-h-full tw-w-full tw-max-w-[500px]">
          <q-img src="~assets/image-svg/stripe-payment.svg"
            class="tw-h-[300px] sm:tw-h-[500px] md:tw-h-[600px] tw-w-full" fit="contain" gsap="payment-card-img" />
        </div>
      </article>
    </div>
  </section>
